...
| Decide whether a linked project may be written to | — | — (the `crossProject` section of the writing project's settings: its policy and its list of targets) | Project settings - *Writing to other projects* and *Projects this one may write to* |
