...
reports that to you instead of working a card whose turn has not come. On the board a blocked card carries a
warning tag for each card it waits for ("blocked by TASK-12"). The block lifts when the blocking card
