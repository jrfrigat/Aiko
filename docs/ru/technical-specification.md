...
| 7 | Хранение | Реализовано: файлы `.aiko` + SQLite-индекс, `reindex`. FileSystemWatcher и reconciliation — post-MVP |
...
| 20 | Git | Политики коммитов реализованы; push — post-MVP |
...
| 24 | Конфигурация | Реализовано: глобальные настройки как defaults, проектные переопределения, эффективный источник в ответе |
