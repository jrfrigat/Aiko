...
- **Стандартный шаблон уже проработан** - новый проект начинается с конвейеров story и task, у каждого
...
| Скилл | Что делает |
| :-- | :-- |
| `/aiko-create <тип> <заголовок>`, `/aiko-create-<тип>` | Создать карточку любого типа, объявленного в проекте; Aiko сам назовёт её и положит в бэклог |
